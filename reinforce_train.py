...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_load_from', type=str, default='./results/experiment_reinforce/visual/mdetr_51060.pt')
    # TODO: DELETE THIS
    # TODO: DELETE THIS
    parser.add_argument('--randomize_range', type=str, default='False')
    parser.add_argument('--range_offset', type=int, default=51060)
    # TODO: DELETE THIS
    # TODO: DELETE THIS
